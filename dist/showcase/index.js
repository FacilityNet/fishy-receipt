...
function drawFish(onClick) {
    ...
    return (react.createElement("div", { className: "fish-container " + fishContainerClass, style: { left: left, top: top, transform: transform, animation: animation }, onClick: onClick },
...
var Fish = function (_a) {
    ...
    return (react.createElement("div", { id: "ocean", className: "ocean", style: oceanStyle },
        react.createElement("div", { className: "todays-word" },
            react.createElement("p", null, wordOfTheDay)),
        repeat(numberOfFish, drawFish, handleClick)));
};

reactDom.render(react.createElement(react.Fragment, null,
    react.createElement("div", { className: "content-before" }),
    react.createElement("div", { className: "container" },
        react.createElement(Fish, { ocean: { widthInVw: 100, heightInVh: 50 }, fish: { count: 10, color: "rebeccapurple" }, word: { text: "APPELSIN", color: "yellow" } }),
