    ...
    return tslib.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, f.apply(void 0, tslib.__spread(args))];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
...
function drawFish(onClick) {
    ...
    return (React__default['default'].createElement("div", { className: "fish-container " + fishContainerClass, style: { left: left, top: top, transform: transform, animation: animation }, onClick: onClick },
...
var Fish = function (_a) {
    ...
    return (React__default['default'].createElement("div", { id: "ocean", className: "ocean", style: oceanStyle },
        React__default['default'].createElement("div", { className: "todays-word" },
            React__default['default'].createElement("p", null, wordOfTheDay)),
