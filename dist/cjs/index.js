    ...
    return tslib.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, f.apply(void 0, tslib.__spread([i], args))];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
...
function drawFish(key, onClick) {
    ...
    return (React__default['default'].createElement("div", { key: key, className: "fish-container " + fishContainerClass, style: { left: left, top: top, transform: transform, animation: animation }, onClick: onClick },
        React__default['default'].createElement("div", { className: "fish fish-color" },
            React__default['default'].createElement("div", { className: "fish-eyes" }),
            React__default['default'].createElement("div", { className: "fish-tail" }))));
}
var Fish = function (_a) {
    ...
    var oceanStyle = tslib.__spread(generateStyles()).reduce(function (acc, cur) { return (Object.assign(acc, cur)); }, {});
    ...
    return (React__default['default'].createElement("div", { id: "ocean", className: "ocean", style: oceanStyle },
        React__default['default'].createElement("div", { className: "todays-word" },
            React__default['default'].createElement("p", null, wordOfTheDay)), tslib.__spread(repeat(numberOfFish, drawFish, handleClick))));
};
